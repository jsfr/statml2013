...
The source code can be found in Appendix \ref{sec:source_code}.

\subsection{Univariate Gaussian distributions}
\label{sub:univariate_gaussian_distributions}

\missing{A little overall about the source code.}
\missingfigure{plot for each of the distributions.}
...
\missing{A little overall about the source code.}
\missingfigure{plot for the data set.}

\subsection{Means}
\label{sub:means}

\missing{A little overall about the source code.}
\missingfigure{plot of the data with means.}

\missing{quantitative evaluation of deviation and explanation of what the quantity means; consise discussion of the reason for the deviation}
